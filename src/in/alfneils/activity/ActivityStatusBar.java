...
public class ActivityStatusBar extends SherlockPreferenceActivity implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences sharedPreferences = getSharedPreferences("Alfahmi",Context.MODE_WORLD_READABLE + Context.MODE_WORLD_WRITEABLE);
		...
		String bgcolor = getSharedPreferences("Alfahmi", Context.MODE_PRIVATE).getString("warnaStatusbar", "#ff000000");
